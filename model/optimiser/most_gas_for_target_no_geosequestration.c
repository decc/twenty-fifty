// To use, run:
// clang most_gas_for_target_no_geosequestratoin.c; ./a.out
// or
// gcc most_gas_for_target_no_geosequestratoin.c; ./a.out
//
#include "optimiser.c"

static void setup_run() {
  printf("Optimising for most natural gas in 2050 but also meeting the 80%% emissions reduction target, without geosequestration\n\n");
  number_of_choices[50] = 1; // Limit Geosequestration choice to level 1
}
