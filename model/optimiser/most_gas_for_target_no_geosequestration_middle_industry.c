...
static void setup_run() {
  printf("Optimising for most natural gas in 2050 but also meeting the 80%% emissions reduction target, without geosequestration, without shrinking industry\n\n");
  number_of_choices[40] = 2; // Limit Industry growth choice to level 1 or 2
