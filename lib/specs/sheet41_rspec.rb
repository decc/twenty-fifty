...
describe 'Sheet41' do
  ...
  it 'cell g173 should equal 0.01740042951329754' do
    sheet41.g173.should be_within(0.001740042951329754).of(0.01740042951329754)
  end

  it 'cell o173 should equal 0.0' do
    sheet41.o173.should be_within(1.0e-08).of(0.0)
  end

  it 'cell g174 should equal 2.4360601318616557' do
    sheet41.g174.should be_within(0.2436060131861656).of(2.4360601318616557)
  end

  it 'cell o174 should equal 0.0' do
    sheet41.o174.should be_within(1.0e-08).of(0.0)
  end
  ...
  it 'cell g176 should equal 0.3480085902659508' do
    sheet41.g176.should be_within(0.034800859026595084).of(0.3480085902659508)
  end

  it 'cell o176 should equal 0.0' do
    sheet41.o176.should be_within(1.0e-08).of(0.0)
  end
