...
class Sheet34 < Spreadsheet
  ...
  def n14; 2045.0; end
  def o14; 2050.0; end
  def f15; @f15 ||= max(-sheet56.t103,0.0); end
  def g15; @g15 ||= max(-sheet57.t103,0.0); end
  def h15; @h15 ||= max(-sheet58.t103,0.0); end
  def i15; @i15 ||= max(-sheet59.t103,0.0); end
  def j15; @j15 ||= max(-sheet60.t103,0.0); end
  def k15; @k15 ||= max(-sheet61.t103,0.0); end
  def l15; @l15 ||= max(-sheet62.t103,0.0); end
  def m15; @m15 ||= max(-sheet63.t103,0.0); end
  def n15; @n15 ||= max(-sheet64.t103,0.0); end
  def o15; @o15 ||= max(-sheet65.t103,0.0); end
  def n17; "B.11"; end
  def f19; 2007.0; end
  def g19; 2010.0; end
  def h19; 2015.0; end
  ...
  def o19; 2050.0; end
  def c20; "VII.c"; end
  def f20; @f20 ||= iferror(sheet36.f447,0.0); end
  def g20; @g20 ||= iferror(sheet36.g447,0.0); end
  def h20; @h20 ||= iferror(sheet36.h447,0.0); end
  def i20; @i20 ||= iferror(sheet36.i447,0.0); end
  def j20; @j20 ||= iferror(sheet36.j447,0.0); end
  def k20; @k20 ||= iferror(sheet36.k447,0.0); end
  def l20; @l20 ||= iferror(sheet36.l447,0.0); end
  def m20; @m20 ||= iferror(sheet36.m447,0.0); end
  def n20; @n20 ||= iferror(sheet36.n447,0.0); end
  def o20; @o20 ||= iferror(sheet36.o447,0.0); end
  def f29; 0.0; end
  def g29; 0.0; end
  def h29; 0.0; end
  def i29; 0.0; end
  ...
  def f114; @f114 ||= f15*sheet14.e58; end
  def g114; @g114 ||= g15*sheet14.e58; end
  def h114; @h114 ||= h15*sheet14.e58; end
  def i114; @i114 ||= i15*sheet14.e58; end
  def j114; @j114 ||= j15*sheet14.e58; end
  def k114; @k114 ||= k15*sheet14.e58; end
  def l114; @l114 ||= l15*sheet14.e58; end
  def m114; @m114 ||= m15*sheet14.e58; end
  def n114; @n114 ||= n15*sheet14.e58; end
  def o114; @o114 ||= o15*sheet14.e58; end
  def f115; @f115 ||= -f109*sheet14.e58; end
  def g115; @g115 ||= -g109*sheet14.e58; end
  def h115; @h115 ||= -h109*sheet14.e58; end
  def i115; @i115 ||= -i109*sheet14.e58; end
  def j115; @j115 ||= -j109*sheet14.e58; end
  def k115; @k115 ||= -k109*sheet14.e58; end
  def l115; @l115 ||= -l109*sheet14.e58; end
  def m115; @m115 ||= -m109*sheet14.e58; end
  def n115; @n115 ||= -n109*sheet14.e58; end
  def o115; @o115 ||= -o109*sheet14.e58; end
  ...
  def f124; @f124 ||= (f120*sheet14.e58)/f49/(1.0-f50); end
  def g124; @g124 ||= (g120*sheet14.e58)/f49/(1.0-f50); end
  def h124; @h124 ||= (h120*sheet14.e58)/f49/(1.0-f50); end
  def i124; @i124 ||= (i120*sheet14.e58)/f49/(1.0-f50); end
  def j124; @j124 ||= (j120*sheet14.e58)/f49/(1.0-f50); end
  def k124; @k124 ||= (k120*sheet14.e58)/f49/(1.0-f50); end
  def l124; @l124 ||= (l120*sheet14.e58)/f49/(1.0-f50); end
  def m124; @m124 ||= (m120*sheet14.e58)/f49/(1.0-f50); end
  def n124; @n124 ||= (n120*sheet14.e58)/f49/(1.0-f50); end
  def o124; @o124 ||= (o120*sheet14.e58)/f49/(1.0-f50); end
