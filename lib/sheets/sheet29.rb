...
class Sheet29 < Spreadsheet
  ...
  def h237; @h237 ||= (1.0*sheet11.e74*sheet29.e193); end
  ...
  def p237; @p237 ||= (1.0*sheet11.e74*sheet29.e193); end
  def f238; @f238 ||= (p238-h238)/(p231-h231); end
  def h238; @h238 ||= (1.0*sheet11.e74*sheet29.e194); end
  ...
  def d364; "DRY"; end
  def f364; @f364 ||= (f346+f352+f358)*sheet29.f156; end
  def g364; @g364 ||= (g346+g352+g358)*sheet29.f156; end
  def h364; @h364 ||= (h346+h352+h358)*sheet29.f156; end
  def i364; @i364 ||= (i346+i352+i358)*sheet29.f156; end
  def j364; @j364 ||= (j346+j352+j358)*sheet29.f156; end
  def k364; @k364 ||= (k346+k352+k358)*sheet29.f156; end
  def l364; @l364 ||= (l346+l352+l358)*sheet29.f156; end
  def m364; @m364 ||= (m346+m352+m358)*sheet29.f156; end
  def n364; @n364 ||= (n346+n352+n358)*sheet29.f156; end
  def o364; @o364 ||= (o346+o352+o358)*sheet29.f156; end
  def d365; "WET"; end
  def f365; @f365 ||= (f347+f353+f359)*sheet29.f157; end
  def g365; @g365 ||= (g347+g353+g359)*sheet29.f157; end
  def h365; @h365 ||= (h347+h353+h359)*sheet29.f157; end
  def i365; @i365 ||= (i347+i353+i359)*sheet29.f157; end
  def j365; @j365 ||= (j347+j353+j359)*sheet29.f157; end
  def k365; @k365 ||= (k347+k353+k359)*sheet29.f157; end
  def l365; @l365 ||= (l347+l353+l359)*sheet29.f157; end
  def m365; @m365 ||= (m347+m353+m359)*sheet29.f157; end
  def n365; @n365 ||= (n347+n353+n359)*sheet29.f157; end
  def o365; @o365 ||= (o347+o353+o359)*sheet29.f157; end
  def d366; "SOLID"; end
  def f366; @f366 ||= (f348+f354+f360)*sheet29.f158; end
  def g366; @g366 ||= (g348+g354+g360)*sheet29.f158; end
  def h366; @h366 ||= (h348+h354+h360)*sheet29.f158; end
  def i366; @i366 ||= (i348+i354+i360)*sheet29.f158; end
  def j366; @j366 ||= (j348+j354+j360)*sheet29.f158; end
  def k366; @k366 ||= (k348+k354+k360)*sheet29.f158; end
  def l366; @l366 ||= (l348+l354+l360)*sheet29.f158; end
  def m366; @m366 ||= (m348+m354+m360)*sheet29.f158; end
  def n366; @n366 ||= (n348+n354+n360)*sheet29.f158; end
  def o366; @o366 ||= (o348+o354+o360)*sheet29.f158; end
  ...
  def f394; @f394 ||= f388*f393*sheet13.k9; end
  def g394; @g394 ||= g388*g393*sheet13.k9; end
  def h394; @h394 ||= h388*h393*sheet13.k9; end
  def i394; @i394 ||= i388*i393*sheet13.k9; end
  def j394; @j394 ||= j388*j393*sheet13.k9; end
  def k394; @k394 ||= k388*k393*sheet13.k9; end
  def l394; @l394 ||= l388*l393*sheet13.k9; end
  def m394; @m394 ||= m388*m393*sheet13.k9; end
  def n394; @n394 ||= n388*n393*sheet13.k9; end
  def o394; @o394 ||= o388*o393*sheet13.k9; end
  ...
  def f425; 1000.0; end
  def g425; @g425 ||= g420/u242; end
  def h425; @h425 ||= h420/u242; end
  def i425; @i425 ||= i420/u242; end
  def j425; @j425 ||= j420/u242; end
  def k425; @k425 ||= k420/u242; end
  def l425; @l425 ||= l420/u242; end
  def m425; @m425 ||= m420/u242; end
  def n425; @n425 ||= n420/u242; end
  def o425; @o425 ||= o420/u242; end
  ...
  def f440; @f440 ||= f408/u253; end
  def g440; @g440 ||= g408/u253; end
  def h440; @h440 ||= h408/u253; end
  def i440; @i440 ||= i408/u253; end
  def j440; @j440 ||= j408/u253; end
  def k440; @k440 ||= k408/u253; end
  def l440; @l440 ||= l408/u253; end
  def m440; @m440 ||= m408/u253; end
  def n440; @n440 ||= n408/u253; end
  def o440; @o440 ||= o408/u253; end
  ...
  def g490; @g490 ||= (g440)*z253; end
  def h490; @h490 ||= (h440)*aa253; end
  def i490; @i490 ||= (i440)*ab253; end
  def j490; @j490 ||= (j440)*ac253; end
  def k490; @k490 ||= (k440)*ad253; end
  def l490; @l490 ||= (l440)*ae253; end
  def m490; @m490 ||= (m440)*af253; end
  def n490; @n490 ||= (n440)*ag253; end
  def o490; @o490 ||= (o440)*ah253; end
