...
class Sheet35 < Spreadsheet
  ...
  def o8; "2050"; end
  def c9; "V.01"; end
  def f9; @f9 ||= index(sheet56.a('g6','bl110'),match("Subtotal."+(a2).to_s,sheet56.a('c6','c110'),0.0),13.0); end
  def g9; @g9 ||= index(sheet57.a('g6','bl110'),match("Subtotal."+(a2).to_s,sheet57.a('c6','c110'),0.0),13.0); end
  def h9; @h9 ||= index(sheet58.a('g6','bl110'),match("Subtotal."+(a2).to_s,sheet58.a('c6','c110'),0.0),13.0); end
  def i9; @i9 ||= index(sheet59.a('g6','bl110'),match("Subtotal."+(a2).to_s,sheet59.a('c6','c110'),0.0),13.0); end
  def j9; @j9 ||= index(sheet60.a('g6','bl110'),match("Subtotal."+(a2).to_s,sheet60.a('c6','c110'),0.0),13.0); end
  def k9; @k9 ||= index(sheet61.a('g6','bl110'),match("Subtotal."+(a2).to_s,sheet61.a('c6','c110'),0.0),13.0); end
  def l9; @l9 ||= index(sheet62.a('g6','bl110'),match("Subtotal."+(a2).to_s,sheet62.a('c6','c110'),0.0),13.0); end
  def m9; @m9 ||= index(sheet63.a('g6','bl110'),match("Subtotal."+(a2).to_s,sheet63.a('c6','c110'),0.0),13.0); end
  def n9; @n9 ||= index(sheet64.a('g6','bl110'),match("Subtotal."+(a2).to_s,sheet64.a('c6','c110'),0.0),13.0); end
  def o9; @o9 ||= index(sheet65.a('g6','bl110'),match("Subtotal."+(a2).to_s,sheet65.a('c6','c110'),0.0),13.0); end
  ...
  def n56; 3.0; end
  def o56; 3.0; end
  def f65; @f65 ||= -sheet35.a('f9','f9'); end
  def g65; @g65 ||= -sheet35.a('g9','g9'); end
  def h65; @h65 ||= -sheet35.a('h9','h9'); end
  def i65; @i65 ||= -sheet35.a('i9','i9'); end
  def j65; @j65 ||= -sheet35.a('j9','j9'); end
  def k65; @k65 ||= -sheet35.a('k9','k9'); end
  def l65; @l65 ||= -sheet35.a('l9','l9'); end
  def m65; @m65 ||= -sheet35.a('m9','m9'); end
  def n65; @n65 ||= -sheet35.a('n9','n9'); end
  def o65; @o65 ||= -sheet35.a('o9','o9'); end
